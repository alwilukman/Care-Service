...
class ArtikelLiveData (private val db: DatabaseReference): LiveData<List<ArtikelEntities>>() {

    private val data = ArrayList<ArtikelEntities>()
    ...
    private val listener = object: ChildEventListener {
        ...
        override fun onChildChanged(snapshot: DataSnapshot, previousChildName: String?) {
            val dealer = snapshot.getValue<ArtikelEntities>() ?: return
